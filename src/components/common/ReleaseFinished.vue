      ...
      <div class="container">
        ...
        <div class="contw">
          ...
          >
            ...
            <el-table-column prop="autoTaskId" label="任务Id" width="150"></el-table-column>
            <el-table-column prop="title" label="任务标题" width="500"></el-table-column>
            ...
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                ...
                <el-button type="text">
                  <router-link
                    :to="{ path: '/Details',query:{id:scope.row.autoTaskId,state:'/ReleaseFinished'}}"
                  >详情</router-link>
                </el-button>
              </template>
            </el-table-column>
...
export default {
  ...
  created() {
    if (sessionStorage.getItem("relePageSize")) {
      this.pageSize = sessionStorage.getItem("relePageSize") * 1;
    }
    if (sessionStorage.getItem("releCur_page")) {
      this.cur_page = sessionStorage.getItem("releCur_page") * 1;
    }
    this.getData();
  },
  computed: {},
  methods: {
    ...
    chaSecah() {
      this.cur_page = 1;
      sessionStorage.setItem("releCur_page", this.cur_page);
      this.update();
    },
    //刷新列表
    update() {
    ...
    handleCurrentChange(val) {
      this.cur_page = val;
      sessionStorage.setItem("relePageSize", this.pageSize);
      sessionStorage.setItem("releCur_page", this.cur_page);
      this.getData();
    },
