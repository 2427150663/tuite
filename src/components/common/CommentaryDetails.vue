    ...
    <div class="crumbs">
      <el-breadcrumb>
        <div class="lineq">
          <span
            ...
            v-on:click="back"
          ></span>
          <span style="font-size:15px;font-weight:400">跟评列表</span>/任务详情
          <div class="fr frLeft" v-if="chanGeUrl=='/CommentaryFinished'">
      ...
      <div class="container">
        ...
        <div class="contw">
          ...
          >
            <el-table-column prop="autoTaskItemCommandId" label="任务Id" width="100" align="center"></el-table-column>
            <el-table-column prop="content" label="跟评内容" width="400"></el-table-column>
            <el-table-column prop="twitterAccountName" label="评论昵称" width="120" align="center"></el-table-column>
            <el-table-column prop="createTime" label="提交时间" width="150"></el-table-column>
            <el-table-column prop="state" label="跟评状态">
            ...
            <el-table-column prop="message" label="评论地址" width="400">
              <template slot-scope="scope" v-if="scope.row.state== 'Success'">
