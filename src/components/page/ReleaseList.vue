<template>
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb>
        <div class="lineq" style="font-size:14px;border-left: 2px solid #66B1FF;">发布列表</div>
      </el-breadcrumb>
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="执行中任务" name="/ReleaseExecuting"></el-tab-pane>
        <el-tab-pane label="已完成任务" name="/ReleaseFinished"></el-tab-pane>
      </el-tabs>
...
export default {
  ...
  created() {
    ...
    sessionStorage.setItem("ComCur_page", 1);
    sessionStorage.setItem("secCur_page", 1);
  },
  computed: {},
  methods: {
    // 分页导航
